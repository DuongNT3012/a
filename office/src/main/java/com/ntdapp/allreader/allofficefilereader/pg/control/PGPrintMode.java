 ...
 * 时间:              上午10:53:24
 */
package com.ntdapp.allreader.allofficefilereader.pg.control;

import com.ntdapp.allreader.allofficefilereader.common.IOfficeToPicture;
...
import com.ntdapp.allreader.allofficefilereader.pg.view.SlideDrawKit;
...
import com.ntdapp.allreader.allofficefilereader.system.IMainFrame;
import com.ntdapp.allreader.allofficefilereader.system.SysKit;
import com.ntdapp.allreader.allofficefilereader.system.beans.pagelist.APageListItem;
import com.ntdapp.allreader.allofficefilereader.system.beans.pagelist.APageListView;
import com.ntdapp.allreader.allofficefilereader.system.beans.pagelist.IPageListViewListener;
...
public class PGPrintMode extends FrameLayout implements IPageListViewListener
{
    ...
    private void drawPageNubmer(Canvas canvas)
    {
        if (control.getMainFrame().isDrawPageNumber())
        {
            ...
            String pn = "Page "+String.valueOf((listView.getCurrentPageNumber()) + " of " + pgModel.getSlideCount());
            int w = (int)150;
            int h = (int)40;
