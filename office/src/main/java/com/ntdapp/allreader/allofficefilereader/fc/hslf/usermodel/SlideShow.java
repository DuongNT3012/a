...
import com.ntdapp.allreader.allofficefilereader.fc.hslf.exceptions.CorruptPowerPointFileException;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.model.HeadersFooters;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.model.Hyperlink;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.model.MovieShape;
...
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Document;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.DocumentAtom;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.ExAviMovie;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.ExControl;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.ExHyperlink;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.ExHyperlinkAtom;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.ExMCIMovie;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.ExObjList;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.ExObjListAtom;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.ExOleObjAtom;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.ExVideoContainer;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.ExtendedParagraphHeaderAtom;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.ExtendedPresRuleContainer;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.FontCollection;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.HeadersFootersContainer;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.PersistPtrHolder;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.PositionDependentRecord;
...
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.RecordContainer;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.RecordTypes;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.SlideListWithText;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.SlidePersistAtom;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.ExtendedPresRuleContainer.ExtendedParaAtomsSet;
import com.ntdapp.allreader.allofficefilereader.fc.hslf.record.SlideListWithText.SlideAtomsSet;
    ...
    private void buildSlidesAndNotes()
    {
        ...
        if (masterSLWT != null)
        {
            ...
            for (int i = 0; i < masterSets.length; i++)
            {
                ...
                if (r instanceof com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Slide)
                {
                    TitleMaster master = new TitleMaster((com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Slide)r, sheetNo);
                    master.setSlideShow(this);
                    tmr.add(master);
                }
                else if (r instanceof com.ntdapp.allreader.allofficefilereader.fc.hslf.record.MainMaster)
                {
                    SlideMaster master = new SlideMaster((com.ntdapp.allreader.allofficefilereader.fc.hslf.record.MainMaster)r, sheetNo);
                    master.setSlideShow(this);
                    mmr.add(master);
                }
            }
        ...
        com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Notes[] notesRecords;
        SlideAtomsSet[] notesSets = new SlideAtomsSet[0];
        Hashtable<Integer, Integer> slideIdToNotes = new Hashtable<Integer, Integer>();
        if (notesSLWT == null)
        {

            notesRecords = new com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Notes[0];
        }
        else
        {
            notesSets = notesSLWT.getSlideAtomsSets();
            ArrayList<com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Notes> notesRecordsL = new ArrayList<com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Notes>();
            for (int i = 0; i < notesSets.length; i++)
            {
                Record r = getCoreRecordForSAS(notesSets[i]);

                if (r instanceof com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Notes)
                {
                    com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Notes notesRecord = (com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Notes)r;
            ...
            notesRecords = new com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Notes[notesRecordsL.size()];
            notesRecords = notesRecordsL.toArray(notesRecords);
        }

        com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Slide[] slidesRecords;
        SlideAtomsSet[] slidesSets = new SlideAtomsSet[0];
        if (slidesSLWT == null)
        {
            slidesRecords = new com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Slide[0];
        }
        else
        {

            slidesSets = slidesSLWT.getSlideAtomsSets();
            slidesRecords = new com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Slide[slidesSets.length];
            for (int i = 0; i < slidesSets.length; i++)
            {
                ...
                if (r instanceof com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Slide)
                {
                    slidesRecords[i] = (com.ntdapp.allreader.allofficefilereader.fc.hslf.record.Slide)r;
                }
