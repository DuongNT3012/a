...
package com.ntdapp.allreader.allofficefilereader.wp.control;
...
import com.ntdapp.allreader.allofficefilereader.pg.animate.FadeAnimation;
import com.ntdapp.allreader.allofficefilereader.simpletext.control.Highlight;
...
import com.ntdapp.allreader.allofficefilereader.system.IDialogAction;
...
import com.ntdapp.allreader.allofficefilereader.wp.view.LayoutKit;
import com.ntdapp.allreader.allofficefilereader.wp.view.NormalRoot;
import com.ntdapp.allreader.allofficefilereader.wp.view.PageRoot;
import com.ntdapp.allreader.allofficefilereader.wp.view.PageView;
import com.ntdapp.allreader.allofficefilereader.wp.view.WPViewKit;
...
public class Word extends LinearLayout implements IWord
{
    ...
    private void drawPageNubmer(Canvas canvas, float zoom)
    {
        ...
        if (control.getMainFrame().isDrawPageNumber() && pageRoot != null)
        {
            ...
            String pn = "Page "+String.valueOf(currentNumber) + " of "
