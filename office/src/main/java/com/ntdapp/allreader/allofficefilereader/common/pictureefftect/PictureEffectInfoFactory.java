 ...
 * 时间:              上午9:08:14
 */
package com.ntdapp.allreader.allofficefilereader.common.pictureefftect;
...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(com.ntdapp.allreader.allofficefilereader.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
