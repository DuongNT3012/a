package com.ntdapp.allreader.allofficefilereader.fc.dom4j.p009io;

import com.ntdapp.allreader.allofficefilereader.fc.dom4j.Attribute;
import com.ntdapp.allreader.allofficefilereader.fc.dom4j.CDATA;
import com.ntdapp.allreader.allofficefilereader.fc.dom4j.Comment;
import com.ntdapp.allreader.allofficefilereader.fc.dom4j.DocumentException;
import com.ntdapp.allreader.allofficefilereader.fc.dom4j.Element;
import com.ntdapp.allreader.allofficefilereader.fc.dom4j.Entity;
import com.ntdapp.allreader.allofficefilereader.fc.dom4j.Namespace;
import com.ntdapp.allreader.allofficefilereader.fc.dom4j.ProcessingInstruction;
import com.ntdapp.allreader.allofficefilereader.fc.dom4j.Text;
import com.ntdapp.allreader.allofficefilereader.fc.dom4j.tree.NamespaceStack;
...
public class DOMWriter {
    ...
    public Document write(com.ntdapp.allreader.allofficefilereader.fc.dom4j.Document document) throws DocumentException {
    ...
    public Document write(com.ntdapp.allreader.allofficefilereader.fc.dom4j.Document document, DOMImplementation dOMImplementation) throws DocumentException {
        if (document instanceof Document) {
            return (Document) document;
        }
        resetNamespaceStack();
    ...
    protected Document createDomDocument(com.ntdapp.allreader.allofficefilereader.fc.dom4j.Document document) throws DocumentException {
        Class cls = this.domDocumentClass;
        if (cls != null) {
            try {
    ...
    protected Document createDomDocument(com.ntdapp.allreader.allofficefilereader.fc.dom4j.Document document, DOMImplementation dOMImplementation) throws DocumentException {
