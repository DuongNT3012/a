...
public class Color implements java.io.Serializable
{
     ...
     * @see        com.ntdapp.allreader.allofficefilereader.java.awt.Color#darker
     * @since      JDK1.0
     */
     ...
     * @see        com.ntdapp.allreader.allofficefilereader.java.awt.Color#brighter
     * @since      JDK1.0
     */
    public Color darker()
    {
     ...
     * @see      com.ntdapp.allreader.allofficefilereader.java.awt.Color#Color(int)
     * @since    JDK1.0
     */
     ...
     * @see       com.ntdapp.allreader.allofficefilereader.java.awt.Color#getRGB()
     * @see       com.ntdapp.allreader.allofficefilereader.java.awt.Color#Color(int)
     * @see       java.awt.image.ColorModel#getRGBdefault()
     * @since     JDK1.0
     */
