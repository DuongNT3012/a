...
public class OfficeViewerScreenActivity extends AppCompatActivity implements IMainFrame {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(com.document.officereader.R.layout.activity_office);
        FrameLayout layoutMain = findViewById(com.document.officereader.R.id.appFrame);
        layoutMain.addView(this.appFrame);

        initData();
        handleEvents();
        //ads
        Admod.getInstance().loadBanner(OfficeViewerScreenActivity.this, getString(com.document.officereader.R.string.banner_all));
    ...
    private void initData() {
        fab = findViewById(com.document.officereader.R.id.fab);
        fabSnapScreen = findViewById(com.document.officereader.R.id.fab_snapscreen);
        fabShare = findViewById(com.document.officereader.R.id.fab_share);
        fabFavorite = findViewById(com.document.officereader.R.id.fab_favourite);
        layoutFabGotoPage = findViewById(com.document.officereader.R.id.layout_fab_gotopage);
        layoutFabSnapScreen = findViewById(com.document.officereader.R.id.layout_fab_snapscreen);
        layoutFabShare = findViewById(com.document.officereader.R.id.layout_fab_share);
        layoutFabFavorite = findViewById(com.document.officereader.R.id.layout_fab_favourite);
        layoutPdf = findViewById(com.document.officereader.R.id.layoutPdf);
        ll_option = findViewById(com.document.officereader.R.id.ll_option);
        toolbar_view = findViewById(com.document.officereader.R.id.toolbar_view);
        tv_work = findViewById(com.document.officereader.R.id.tv_work);
        ...
        if (mIsFavorite) {
            fabFavorite.setImageResource(com.document.officereader.R.drawable.option_bookmark);
        } else {
            fabFavorite.setImageResource(com.document.officereader.R.drawable.option_bookmark_unselect);
        }
    }

    private void handleEvents() {
        findViewById(com.document.officereader.R.id.appFrame).setOnClickListener(view -> {
            mIsShowMenu = false;
        ...
        layoutFabShare.setOnClickListener(view -> {
            ...
            Intent intent = Utils.INSTANCE.fileShareIntent(getString(com.document.officereader.R.string.fab_share), fileUri);
        ...
        findViewById(com.document.officereader.R.id.btnBack).setOnClickListener(view -> {
            if (fromSplash) {
...
//        this.appFrame.addView(this.toolsbar);
    ...
    public void openFileFinish() {
        ...
        this.control.getView().setBackgroundResource(com.document.officereader.R.drawable.bg_office);
